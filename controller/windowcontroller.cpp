...
void WindowController::drawBars(){
    ...
    int healthBarWidth = static_cast<int>(40 * tileSize * healthRatio);

    // Clear the old health bar rectangle
    QRect oldHealthBarRect(barX, barY, 40 * tileSize, 20); // Full width of the map
    ...
    QRect healthBarRect(barX, barY, healthBarWidth, 20); // You can adjust the height as needed
    ...
    int energyBarWidth = 40 * tileSize * energyRatio; // Full width of the map
    int energyBarHeight = 20; // You can adjust the height as needed

    QRect oldEnergyBarRect(barX, barY - energyBarHeight, 40 * tileSize, 20); // Full width of the map
